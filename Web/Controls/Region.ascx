<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Region.ascx.cs" Inherits="Web.Controls.Region" %>
...
<%}else{ %>
<div>
    <asp:Label ID="ltP" Text="北京市" runat="server"></asp:Label>—<asp:Label ID="ltC" Text="北京市" runat="server"></asp:Label>
</div>
<%} %>