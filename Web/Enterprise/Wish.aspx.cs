...
{
    public partial class Wish : MLMGC.Security.EnterprisePage
    {
        ...
        {
            string url = string.Format(Request.Url.AbsolutePath + "?name={0}&day={1}&wishid={2}{3}", txtName.Text.Trim(), txtDay.Text,ddlWish.SelectedValue,Property1.Query);
