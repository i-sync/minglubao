...
{
    public partial class LatenceList : MLMGC.Security.EnterprisePage
    {
        ...
        protected void databind()
        {
            ...
            dataCI.Status = EnumClientStatus.潜在客户;
            ...
            data.EPUserTMRID = Requests.GetQueryInt("objid", 0);
            ...
            //绑定数据
            rpList.DataSource = new T_ClientInfo().LeaderLatenceList(data);
            rpList.DataBind();
