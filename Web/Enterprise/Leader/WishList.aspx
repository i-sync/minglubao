<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WishList.aspx.cs" Inherits="Web.Enterprise.Leader.WishList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">        
        $(function () {
            //设置列表宽度（使列头不换行）
            var width = 0;
            $("#divResult .cilist_title li").each(function () {
            ...
            $("#btnSearch").click(function () {
                ...
                var data = "objid=" + objid + "&name=" + escape(name) + "&startdate=" + startdate + "&enddate=" + enddate + "&wishid=" + $("#ddlWish").val() + Property.GetQuery();
                window.location.replace("WishList.aspx?" + data);
            });
            //--加载列表
...
<body>
    ...
    <div class="divlist">
        <table>
            <tr>
                ...
                <td>
                    <input type="button" class="btn1" id="btnSearch" value="检索" />
                </td>
                <td>
            ...
            <tr  id="trProperty" style="display:none;">
                ...
                <td>
                    <asp:DropDownList runat="server" class="ddl1 w160" ID="ddlWish" />
                </td> 
                <td colspan="8">
    ...
    <div class="Statistics" style="display:none;">
        ...
        <div class="divlist">
            <table class="tablist" cellpadding="1" cellspacing="1" style="width: 400px; margin: auto 0 0 10px;">
                <tr>
                    <th>
                        &nbsp;
                    </th>
    ...
    <div style="margin: 10px 20px;">
       <span class="warnBlock"></span><span>深色：即将失败客户(系统自动处理)</span>
    </div>
    <!--结果列表 结束-->
    </form>
    <script id="pagetipsjs" src="/JS/PageTips.js?menuid=25" type="text/javascript"></script>
</body>
</html>
