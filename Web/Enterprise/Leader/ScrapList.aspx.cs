...
{
    public partial class ScrapList : MLMGC.Security.EnterprisePage
    {
        ...
        protected void databind()
        {
            ...
            dataCI.Status = EnumClientStatus.报废客户;

            rpStatistics.DataSource = new T_ClientInfo().LeaderStatisticsScrap(dataCI);
            ...
            //绑定数据
            rpList.DataSource = new T_ClientInfo().LeaderScrapList(data);
            rpList.DataBind();
