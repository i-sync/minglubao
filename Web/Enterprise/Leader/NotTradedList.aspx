<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NotTradedList.aspx.cs"
    Inherits="Web.Enterprise.Leader.NotTradedList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        var URL_CONFIG = {
            ResultUrl: "NotTradedResult.aspx"
        };
        $(function () {
            ...
            $("#btnSearch").click(function () {
                ...
                var data = "objid=" + objid + "&nottradedid=" + $("#ddlNotTraded").val() + "&keyword=" + escape($.trim($("#txtName").val())) + Property.GetQuery();
                window.location.replace("NotTradedList.aspx?" + data);
            });
            //--加载列表
...
<body>
    ...
    <div class="updown"><img src="/images/down.jpg" id="imgUpDown" alt="展开统计" title="展开统计" /></div>
    ...
    <script id="pagetipsjs" src="/JS/PageTips.js?menuid=27" type="text/javascript"></script>
</body>
</html>
