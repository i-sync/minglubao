<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuitApply.aspx.cs" Inherits="Web.Enterprise.Item.QuitApply" %>
        ...
        $(function () {
            ...
            $(".update").click(function () {
                ...
                $.ajax({
                    ...
                    data: { key: "updatestatus", aid: aid, status: status,type:"2" },
                 ...
                 <asp:Repeater runat="server" ID="rpList">
                    <ItemTemplate>
                        <div class="item "> 
                            ...
                            <div class="name" title="<%#Eval("Reason")%>">
                                <%#Eval("Reason")%>
                            </div>
                            <div class="time">
