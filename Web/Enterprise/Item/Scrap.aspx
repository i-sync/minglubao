<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Scrap.aspx.cs" Inherits="Web.Enterprise.Item.Scrap" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#btnSearch").click(function () {
                ...
                var data = "objid=" + objid + "&name=" + escape(name) + "&scrapid=" + scrapid + Property.GetQuery();
                window.location.replace("scrap.aspx?" + data);
            });
    ...
    <div class="divlist">
        <table>
            <tr>
                ...
                <td>
                    <asp:DropDownList runat="server" CssClass="ddl1 w160" ID="ddlScrap" />
                </td>
                <td>
