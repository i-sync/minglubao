...
{
    public partial class AnnLeader : MLMGC.Security.EnterprisePage
    {
        ...
        protected void databind()
        {
            ...
            data = new T_Announcement().GetLeaderModel(data);
            if (data != null)
            {
            ...
            rpList.DataSource = new T_Announcement().GetLeaderList(data);
            rpList.DataBind();
            //设置分页样式
