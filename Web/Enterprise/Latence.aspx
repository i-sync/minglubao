<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Latence.aspx.cs" Inherits="Web.Enterprise.Latence" %>
...
<body>
    ...
    <mlb:AspNetPager runat="server" ID="pageList1" CssClass="paginator" CurrentPageButtonClass="cpb"
        ...
        <div style="margin:10px 20px;">
            <span class="warningBlock"></span>
            <span>红色：报警客户</span>
            &nbsp;&nbsp;
            <span class="warnBlock"></span>
            <span>深色：即将共享客户</span>
        </div>
    </form>

    <script id="pagetipsjs" src="/JS/PageTips.js?menuid=11" type="text/javascript"></script>
