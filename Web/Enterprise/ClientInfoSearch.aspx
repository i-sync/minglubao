<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClientInfoSearch.aspx.cs"
    Inherits="Web.Enterprise.ClientInfoSearch" %>
...
<body>
    ...
    <script id="pagetipsjs" src="/JS/PageTips.js?menuid=10" type="text/javascript"></script>
    <script src="../JS/Reservation.js" type="text/javascript"></script>
<script type="text/javascript">
    $(function () {
        $("form").submit(function () {
            var keyword = $.trim($("#txtKeyword").val());
            var url = "ClientInfoSearch.aspx?keyword=" + escape(keyword) + "&type=" + $("#ddlType").val() + "&t=" + Math.random();
            location = url;
            return false;
        });
        var width = 0;
