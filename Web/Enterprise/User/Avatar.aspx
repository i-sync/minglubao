<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Avatar.aspx.cs" Inherits="Web.Enterprise.User.Avatar" %>
            ...
            <table>
                ...
                <tr>
                    <td>                        
                        ...
                        <iframe frameborder="0" src="/enterprise/controls/Upload.aspx?folder=<%=MLMGC.COMP.Config.EnterpriseAvatarFolder %>" width="320" height="30"></iframe>
                    </td>
                </tr>
                <tr>
                    <td>
