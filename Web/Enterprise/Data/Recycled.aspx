<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Recycled.aspx.cs" Inherits="Web.Enterprise.Data.Recycled" %>
...
<body>
    ...
    <div style=" margin:5px;padding:5px 15px;">
        <asp:Button ID ="btnRestore" Text="还原到共享池" OnClick ="btnRestore_Click" CssClass="btn1" runat="server" />
        &nbsp;&nbsp;&nbsp;&nbsp;
