...
namespace Web.Enterprise.Data
{
    ...
    {
        private int _enterpriseid, _epuserid;
        private string _filename;
        private string _path;

        public ImportingData(int EnterpriseID, int EPUserTMRID)
        {
            _enterpriseid = EnterpriseID;
            _epuserid = EPUserTMRID;
            //创建并复制模板文件
            _path = HttpContext.Current.Server.MapPath(".") + @"\DataFile\";
            _filename = _path + string.Format("data_{0}.xml", _epuserid);
        }
        /// <summary>
        /// 创建xml文件
        /// </summary>
    ...
    public class E_ImportingClientInfo : MLMGC.DataEntity.Enterprise.E_ClientInfo
    {
