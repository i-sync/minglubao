...
{
    public partial class ImportingStep2 : MLMGC.Security.EnterprisePage
    {
        ...
        {
            //读取绑定标题
            DataTable dt = new ImportingData(EnterpriceID,EPUserTMRID).TitleSource();
        ...
        protected void btnNext_Click(object sender, EventArgs e)
        {
            ...
            bool b = new ImportingData(EnterpriceID,EPUserTMRID).SaveConfiguration(list);
            if (b)
            {
