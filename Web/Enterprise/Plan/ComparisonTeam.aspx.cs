...
{
    public partial class ComparisonTeam : MLMGC.Security.EnterprisePage
    {
        int TeamModelRoleID = 0;
        protected void Page_Load(object sender, EventArgs e)
        {
            TeamModelRoleID = Requests.GetQueryInt("tmrid", 0);
            if (!IsPostBack)
            {
        ...
        protected void databind()
        {
            ...
            data.TeamID = TeamID;
            data.TeamModelRoleID = TeamModelRoleID;
            ...
            rpList.DataSource = bll.ComparisonTeam(data);
            rpList.DataBind();
        }
