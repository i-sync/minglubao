<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialShare.aspx.cs" Inherits="Web.Enterprise.WenKu.MaterialShare" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>企业 项目资料共享</title>
            ...
            <table class="tabtxtlist">
                ...
                <tr>
                    ...
                    <td >
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="button" class="btn" onclick="window.location.replace('../Material/MaterialList.aspx')" value="返回" />
                    </td>
                </tr>
            </table>
        </div>
