<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TalkEdit.aspx.cs" Inherits="Web.Enterprise.Material.TalkEdit" ValidateRequest="false" %>
    ...
    <div class ="divlist">
        <table>
            ...
            <tr>
                <td>标题：</td>
                <td class=" w500">
                    <asp:TextBox ID ="txtTalkSubject" runat="server" class="txt w500" MaxLength="100"></asp:TextBox>
                </td>
                <td id ="TipsSubject">
                    &nbsp;
                </td>
