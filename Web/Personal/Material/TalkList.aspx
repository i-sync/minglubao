<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TalkList.aspx.cs" Inherits="Web.Personal.Material.TalkList" %>
    ...
    <script language ="javascript" type ="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnPreview").click(function () {
                ...
                $("#divPreviewTalk").load("../Info/Talk.aspx");
                pl.Show();
            });
...
<body>
    ...
    <div class="divlist">
            ...
            <asp:Repeater ID ="rpList" runat="server">
                <ItemTemplate>
                    <tr class="c">
                        ...
                        <td>                            
                            <a href="TalkEdit.aspx?type=update&talkid=<%#Eval("TalkID") %>" >修改</a>
                            <a class="del" href="TalkList.aspx?actionname=delete&talkid=<%#Eval("TalkID") %>">删除</a>
                        </td>
                        <td title='<%#Eval("Detail") %>' style="text-align:left">
                            <%#Eval("TalkSubject") %>
                        </td>
                        <td>
                            <%#Eval("Sort") %>
        ...
        <!--话术预览-->
        <div id ="divPreviewTalk" style="display:none;width:780px;height:400px;overflow:auto;background-color:White; padding:15px">
        </div>
    </div>
    </form>
</body>
