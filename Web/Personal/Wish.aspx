<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wish.aspx.cs" Inherits="Web.Personal.Wish" %>
        ...
        <div class="divlist">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID ="ddlWish" CssClass="ddl1" runat="server"></asp:DropDownList>
                    </td>
                    <td>
