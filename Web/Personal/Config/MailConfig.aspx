<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MailConfig.aspx.cs" Inherits="Web.Personal.Config.MailConfig" %>
    ...
    <script type ="text/javascript">
        ...
        $(function () {
            ...
            $(":radio[name='rdType']").click(function () {
                ...
                $.each(array, function (i) {
                    if (v == array[i].key) {
                        ...
                        //判断是否为yahoo.cn邮箱
                        if (v == "yahoo.cn") {
                            $("#TipsUserName").html("<span class='succ'>别忘加后缀噢！</span>");
            ...
            $("#txtEmail").keyup(function () {
                ...
                var v = $.trim($(this).val());
                //if ($.IsNullOrEmpty($.trim($("#txtUserName").val()))) {
                    $("#txtUserName").val(v);
                //}
            });
//            $("#txtUserName").keyup(function () {
//                //如果txtEmail为空则修改，否则不修改
//                var v = $.trim($(this).val());
//                //if ($.IsNullOrEmpty($.trim($("#txtEmail").val()))) {
//                    $("#txtEmail").val(v);
//                //}
//            });
            ...
            $("#btnSubmit").click(function () {
                ...
                $("#TipsEmail").html("<span class='error'>请输入邮箱</span>");
                }
                if ($.IsNullOrEmpty($("#txtSMTP").val())) {
                $("#TipsSMTP").html("<span class='error'>请输入邮件服务器</span>");
                }
                if ($.IsNullOrEmpty($("#txtPort").val())) {
                $("#TipsPort").html("<span class='error'>请输入端口号</span>");
                }
                if ($.IsNullOrEmpty($("#txtUserName").val())) {
                $("#TipsUserName").html("<span class='error'>请输入用户名</span>");
                }
    ...
    <div class="divlist">
        <table class="tabtxtlist">
            ...
            <tr>
                ...
                <td id="TipsUserName"  style="width:120px;">
                </td>
            </tr>
            <tr>
                <td class="name130">
