<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Property.aspx.cs" Inherits="Web.Personal.Config.Property" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function setProperty() {
            ...
            var data = "key=601&trade=" + trade + "&area=" + area + "&source=" + source + "&t=" + Math.random();
            var result;
            $("#Tips").show();
            $.ajax({
                type: "GET",
...
<body>
    <form id="form1" runat="server">
        ...
        <i class="line"></i>
        <!--<div>
            <input type="button" runat="server" id="btnTrade" value="设置行业" />
            <input type="button" runat="server" id="btnArea" value="设置地区" />
            <input type="button" runat="server" id="btnSource" value="设置来源" />
        </div>
        <iframe src="" id="ifrset" name="ifrset" frameborder="0" style=" width:100%; height:100%"></iframe>
        -->
        <div id="lookbar">
        ...
        <div id="divTab" class="barInfoList">
            <iframe src="" id="ifrset" name="ifrset" frameborder="0" style="width: 100%; height: 100%">
            </iframe>
        </div>
    </form>
</body>
