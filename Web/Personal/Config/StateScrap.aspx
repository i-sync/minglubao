<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StateScrap.aspx.cs" Inherits="Web.Personal.Config.StateScrap" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#txtName").blur(function () {
                ...
                var data = "key=821&scrapid=" + scrapid + "&name=" + escape(name) + "&t=" + Math.random();
                $("#TipsName").html("检测中..");
                $.get(URL_CONFIG.Post_URL, data, function (msg) {
                    if (msg == "0") {
            ...
            $("#btnSubmit").click(function () {
                ...
                var data = "";
                if (type == "add") {
                    data = "key=822&name=" + escape(name) + "&percent=" + percent + "&t=" + Math.random();
                } else {
                    data = "key=823&scrapid=" + scrapid + "&name=" + escape(name) + "&percent=" + percent + "&t=" + Math.random();
                }
                $.get(URL_CONFIG.Post_URL, data, function (msg) {
                    msg = parseInt(msg);
                    if (msg > 0) {
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="width: 650px; border: 1px solid #ccc;background-color:White; height:150px;display: none; padding-left:10px;" id="divScrapInfo">
            <br />
