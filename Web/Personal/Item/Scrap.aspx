<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Scrap.aspx.cs" Inherits="Web.Personal.Item.Scrap" %>
        ...
        <div class="divlist">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID ="ddlScrap" CssClass="ddl1 w190" runat="server"></asp:DropDownList>
                    </td>
                    <td>
