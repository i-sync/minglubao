<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NotTraded.aspx.cs" Inherits="Web.Personal.Item.NotTraded" %>
        ...
        <div class="divlist">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID ="ddlNotTrade" CssClass="ddl1 w190" runat="server"></asp:DropDownList>
                    </td>
                    <td>
