<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Scrap.aspx.cs" Inherits="Web.Personal.Scrap" %>
        ...
        <div class="divlist">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID ="ddlScrap" CssClass="ddl1" runat="server"></asp:DropDownList>
                    </td>
                    <td>
                        报废时间：
                    </td>
