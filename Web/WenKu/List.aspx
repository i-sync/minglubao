<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Web.WenKu.List" %>
            ...
            <asp:Repeater ID="rpList" runat="server">
                <ItemTemplate>
                    <div class="item">
                        ...
                        <div class="name">
                            <a href="Info.aspx?id=<%#Eval("WenKuID") %>" target="_blank" ><%#Eval("Caption") %></a>
                        </div>
                        <div class="name">
                            <%#Eval("Intro") %>
                        </div>
