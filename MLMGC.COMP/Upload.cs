...
namespace MLMGC.COMP
{
    ...
    /// 上传时的主要参数设置：FileName,SavePath
    /// </summary>
    public class Upload
    {
        private int _Error = -1;//返回上传状态。
        private int _MaxSize = 5120000;//最大单个上传文件 (默认)
        private int _Size = 0;//上传文件的大小
        private string _AllowFileType = "jpg/gif/bmp/png/swf";//所支持的上传类型用"/"隔开
        private string _FileType = "";//上传的文件类型
        ...
        private HtmlInputFile _FormFile;//Html上传控件。
        ...
        private int _DrawStyle = 2;//设置加水印的方式０：文字水印模式，１：图片水印模式,2:不加
        ...
        private string _CopyIamgePath = System.Web.HttpContext.Current.Server.MapPath(".") + "/UploadFiles/expotclogo.gif";//图片水印模式下的覆盖图片的实际地址
        ...
        private bool IsUpload(string Ext)
        {
            ...
            _FileType = Ext;
            bool b = false;
            string[] arrFileType = _AllowFileType.Split('/');
